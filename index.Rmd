...
Chord structure matters more to the emotion and story of a song. Just like lyrics, carefully chosen chords move inside the key and change the trajectory of a song. A popular pop progression is the 145, such as in the song "Baby Shark", which became global earworm in 2019. Baby Shark is written in the key of C with a 145 chord progression, and has a predictable and calming resolution.

In the absence of chord structure data, I turn to a key analysis. Despite the verdict that key differences at the emotive level are moot, we still might gain insight at the popularity level. Especially because, from a cursory look at popularity and key, there seems to be great variance between and within artists.
